...
function initOrder() {
  ...
  order_button.on('click', function(){
    ...
    if(firstnamelen >= 1 && lastnamelen >= 1 && emailvalid === true && addresslen >= 1 && citylen >= 1 && countryval != 0 && ziplen >= 1 && phonelen >= 1 && provinceval != 0 && cityval != 0 && courierval !=0 && payment != 0) {
